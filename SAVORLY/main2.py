...
class LoginPage(QWidget):
    ...
    def _submit(self):
        ...
        if ok:
            ...
            self.login_requested.emit(u, msg)
        else:
            self.password_err.show_error(msg)
...
class MainWindow(QMainWindow):
    ...
    def _on_login(self, _, display_name):
        QMessageBox.information(self, "Login Successful", f"Welcome back, {display_name}!")
